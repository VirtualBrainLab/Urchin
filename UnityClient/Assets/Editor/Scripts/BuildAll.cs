...
public class BuildAll
{
    ...
    private static void BuildWindows()
    {
        ...
        {
            scenes = new[] { "Assets/Scenes/UnityMouseRenderer.unity" },
            locationPathName = "Builds/Win64/Urchin.exe",
    ...
    private static void BuildLinux()
    {
        ...
        {
            scenes = new[] { "Assets/Scenes/UnityMouseRenderer.unity" },
            locationPathName = "Builds/Linux/Urchin",
    ...
    private static void BuildWebGL()
    {
        ...
        {
            scenes = new[] { "Assets/Scenes/UnityMouseRenderer.unity" },
            locationPathName = "Builds/WebGL/Urchin",
